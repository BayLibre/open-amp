/* This linker script generated from xt-genldscripts.tpp for LSP ../apps/system/generic/machine/xtensa */
...
SECTIONS
{
  ...
  _end = 0x60400000;
  PROVIDE(end = 0x60400000);
  _heap_sentry = 0x60800000;

  _stack_sentry = 0x60900000;
  PROVIDE(__stack = 0x60a00000);
